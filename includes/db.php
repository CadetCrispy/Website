...
// [2025-06-08 01:16 AM] Ensure lesson_assets table exists
$pdo->exec("CREATE TABLE IF NOT EXISTS lesson_assets (id INT AUTO_INCREMENT PRIMARY KEY, lesson_id INT NULL, filename VARCHAR(255) NOT NULL, original_name VARCHAR(255) NOT NULL, mime_type VARCHAR(100) NOT NULL, uploaded_at DATETIME DEFAULT CURRENT_TIMESTAMP) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;");
